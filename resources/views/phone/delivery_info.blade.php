...
@section('content')
    ...
    ?>
    <div class="bg-success" id="imageview"
         style="display:none;position: fixed;top:0px;bottom: 0px;right: 0px;left: 0px">
...
;"
    ...
    <form action="{{route('updatedelivery_from_phone')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="row pd" id="phototake">
            ...
            <div class="col-12"><h4
                        style="font-weight: 700;font-size: 11.5px;line-height: 19px;color: rgba(0, 0, 0, 0.67);">
                    <strong>Pickup address &nbsp;:</strong>&nbsp; {{$shipmentdata->form}}</h4></div>
            <div class="col-12" id="image_first_view"
                 style=" color: #2B4BF2; padding: 20px;  text-align: center;border: 2px dotted #bfb2b2;border-radius: 39px;">

                <label>
                    <div class="take-picture">
                        <h1 style="padding-bottom: 3px;margin-bottom: 0px;"><img style="height: 96px;"
                                                                                 src="{{asset('scan.png')}}"></h1>
                        <span onclick="hiddenme()" style="font-weight: 700;font-size: 15px; color:#00357b !important;">Scan documents <br></span>
                    </div>
                    <input type="file" accept="image/*" capture="camera" id="logoImage" name="picture"
                           style="display: none;">
                </label>
            </div>

            <div class="col-12"
                 style="display:none;color: #2B4BF2; padding: 20px;  text-align: center;border: 2px dotted #bfb2b2;border-radius: 39px;"
                 id="start-camera3">
                <div class="row">
                    ...
                    <div class="col-4">
                        <label>
                            <div class="take-picture">
                                <h5 id="start-camera2"
                                    style="padding-bottom: 3px;margin-bottom: 0px;margin-top: 70%;"><span
                                            style="
  border: 2px solid;
  ...
  font-weight: 500;">+</span></h5>
                                <span id="start-camera5"
                                      style="font-weight: 700;font-size: 9px; color:#00357b !important;">Add another page<br></span>
                            </div>
                            <input type="file" accept="image/*" capture="camera" id="logoImage" name="picture"
                                   style="display: none;">
                        </label>
            ...
            <h1 style="margin-top:10px;font-weight: 700;font-size: 11px;">Please enter the delivery location And
                time </h1>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-8" style="position: relative">
                    <label class="labeltx" for="">Delivery Location</label>
                    <select name="completed_location_id" class="form-control bdradi" id="" required>
                        <option value="">-SELECT-</option>
                        @foreach($locationInfo as $location)
                            <option value="{{$location->id}}">{{explode(" - ",$location->to)[0]}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="col-6" style="position: relative ">
                ...
                <input required type="date" style="width: 140px;" name="delivery_date"
                       value="{{$shipmentdata->delivery_date}}" class="form-control bdradi">
            </div>
            <div class="col-6" style="position: relative">
                <label class="labeltx" for="">Delivery time</label>
                <input required type="time" name="delivery_time" value="{{$shipmentdata->delivery_time}}"
                       class="form-control bdradi">
            </div>
