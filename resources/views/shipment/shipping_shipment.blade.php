    ...
    <div class="main-content">
        ...
        <div class="row">
            ...
            <div class="m-4 custom_position">
                <h1 class="tableheadtxt">Shipping List</h1>
            </div>
        </div>
                            ...
                            <div class="form-group two">
                                <form action="" method="get">
                                    <div class="daterancegrp">
                                        ...
                                        <span class="iconposition"> <i class="fa fa-calendar-o" id="dateicon"></i></span>

                                    </div>

                                    <button id="submit_btn" type="submit" style="height:0px;width:0px;opacity:0;display: none"></button>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table id="table_id" class="table table-striped table-bordered">
                            ...
                            <tr class="tbl-head-txt tableheadtx">
                                ...
                                <th class="hidden_ico customerth" style="background-image:none !important;">Customer
                                </th>
                                <th class="hidden_ico phoneth" style="background-image:none !important;">Phone No</th>
                                <th class="hidden_ico addressth" style="background-image:none !important;">Pickup
                                    Address
                                </th>
