                        ...
                        <div class="row d-flex justify-content-center">
                                    ...
                                    <div class="form-row row gap-4 justify-content-center g-3 ">
                                        <div class="col-sm-5 card-border-style">
                                            ...
                                            <div class="col-sm-12  mt-4">
                                                <input name="sender_name" value="{{old('name')}}" type="text"
                                            ...
                                            <div class="col-sm-12 mt-4">
                                                <div class="col-sm-12 mt-4">
                                                    <input name="sender_phone" value="{{old('phone')}}" type="text"
                                            ...
                                            <div class="col-sm-12 mt-4">
                                                <input name="sender_email" value="{{old('email')}}" type="text"
                                                       class="form-control inputstyle sender_email"
                                                       placeholder="email *">
                                                <span class="text-danger error_span" id="sender_email">This Field is Required</span>
                                            </div>
                                            <div class="col-sm-12 mt-4">
                                                 <textarea name="sender_address" id="autocomplete" class="form-control sender_address" cols="20" rows="3"
                                        ...
                                        <div class="col-sm-5 card-border-style">
                                            ...
                                            <div class="col-sm-12  mt-4">
                                                <input name="receiver_name" readonly value="fixed Name" type="text"
                                            ...
                                            <div class="col-sm-12 mt-4">
                                                ...
                                                <textarea readonly name="receiver_address" id="" class="form-control" cols="30" rows="3" placeholder="Receiver Address">
                                            ...
                                            <div class="col-sm-12 mt-4">
                                                <input readonly name="receiver_email" value="fixed Email" type="text"
                                                       class="form-control inputstyle"
                                                       placeholder="Mail *">
                                                <span class="text-danger error_span" id="customerEmail">This Field is Required And Must be Email</span>
                                            </div>
                                            <div class="col-sm-12 mt-4">
                                                <input name="receiver_phone" value="{{old('phone')}}" type="text"
                                                       class="form-control inputstyle"
                                                       placeholder="Phone *">
                                                <span class="text-danger error_span" id="customerEmail">This Field is Required And Must be Email</span>
                                            </div>
                            ...
                            <div style="display: none" class="col-sm-10 p-2 step step2 ">
                                ...
                                <div class="text-center frtop" style="margin-top: 32px"><span>Step 2-</span> &nbsp;
                                    <span class="sing">Shipping Items</span></div>
                            ...
                            <div style="display: none" class="col-sm-10 p-2 step step3">
                                ...
                                <div class="col-sm-12 text-center submitbtn">
                                    ...
                                    <button type="submit" class="btn btn-info btnnext"> Submit &nbsp; <img
                                                class="imgiconnext" src="{{asset('assets/frontend/images/arrow.png')}}"
                                                alt=""></button>
    ...
    <div style="display:none">
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="number" oninput="calculation()" value="1" class="standeroption qty" step="any" name="qty[]">
                </td>
                <td>
            ...
            <tr>
                ...
                <td class="tvinput">
                    <div class="input-group mb-3">
                        ...
                        <input type="number" oninput="calculation()"  name="tv_size[]" class="form-control tvsizinput" placeholder="siz" >
